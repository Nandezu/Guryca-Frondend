  ...
  return (
    <View style={styles.container}>
      ...
      {renderImageWithTouchableOpacity(
        ...
        'first',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.455, left: SCREEN_WIDTH * 0.060, zIndex: 1 },
        'NewScreen'
      )}
      {renderImageWithTouchableOpacity(
      ...
      {renderImageWithTouchableOpacity(
        ...
        { width: SCREEN_WIDTH * 0.08, height: SCREEN_HEIGHT * 0.04 },
        'subs',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.01005, left: SCREEN_WIDTH * 0.050, zIndex: 2 },
        'ProfileSetScreen'
      )}
