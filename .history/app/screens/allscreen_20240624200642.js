    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={[styles.imageContainer, { top: 20, left: 0 }]}>
          ...
          />
          <TouchableOpacity
            style={[styles.button, { width: 100, height: 100, top: 22.5, left: 45 }]}
        ...
        <View style={[styles.imageContainer, { top: 20, left: 50 }]}>
          <Image
          ...
          />
          <TouchableOpacity
            style={[styles.button, { width: 80, height: 40, top: 20, left: 40 }]}
