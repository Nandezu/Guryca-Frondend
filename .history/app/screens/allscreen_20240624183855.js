...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    height: 240, // Výška kontejneru ScrollView, která omezuje oblast scrollování
    marginTop: -35, // Posunout dolů, aby byla viditelná správná oblast
    top: 270,
  },
  scrollViewContainer: {
    alignItems: 'center',
  ...
  image: {
    width: 230, // Šířka obrázků ve ScrollView
    height: 230, // Výška obrázků ve ScrollView
    marginHorizontal: 1,
  },
  button: {
    alignItems: 'center',
