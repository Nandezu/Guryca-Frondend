...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, Alert, Linking, Switch, ScrollView } from 'react-native';
...
export default function SignUpScreen() {
  ...
  const handleContinue = () => {
    if (!nickname || !email || !password || !confirmPassword || !shoppingRegion || !gender) {
