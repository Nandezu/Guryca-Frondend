...
export default function DiscoverScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      Our app offers the world's largest selection of over 60,000 clothing products and thousands of brands, allowing you to discover items from top designers to emerging talents.
...
const styles = StyleSheet.create({
  ...
  progressText: {
    ...
    left: '50%',
    transform: [{ translateX: +1 }], // Center horizontally
    color: '#fff',
    fontSize: 20,
    fontWeight: 'light',
  },
