...
export default function GouideScreen2() {
  ...
  return (
    <View style={styles.container}>
      ...
      Effortlessly try on any outfit on your photo in seconds with our virtual fitting feature—just by clicking the TRY ON button.
...
const styles = StyleSheet.create({
  ...
  images: {
    ...
    position: 'absolute',
    top: 600, // Nastavte horní pozici podle potřeby
    left: '50%',
