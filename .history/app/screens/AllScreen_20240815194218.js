...
const getResponsiveDimension = (baseDimension, screenDimension) => {
  return (baseDimension / 100) * screenDimension;
};
...
const AllScreen = () => {
  ...
  const renderImageWithTouchableOpacity = (imageSource, imageStyle, touchableStyle, pressedKey, containerStyle, targetScreen) => {
    ...
    const responsiveImageStyle = {
      width: getResponsiveDimension(imageStyle.width, SCREEN_WIDTH),
      height: getResponsiveDimension(imageStyle.height, SCREEN_HEIGHT),
    };

    const responsiveTouchableStyle = {
      width: getResponsiveDimension(touchableStyle.width, SCREEN_WIDTH),
      height: getResponsiveDimension(touchableStyle.height, SCREEN_HEIGHT),
      top: getResponsiveDimension(touchableStyle.top, SCREEN_HEIGHT),
      left: getResponsiveDimension(touchableStyle.left, SCREEN_WIDTH),
    };

    const responsiveContainerStyle = {
      ...containerStyle,
      top: containerStyle.top ? getResponsiveDimension(containerStyle.top, SCREEN_HEIGHT) : undefined,
      left: containerStyle.left ? getResponsiveDimension(containerStyle.left, SCREEN_WIDTH) : undefined,
      marginTop: containerStyle.marginTop ? getResponsiveDimension(containerStyle.marginTop, SCREEN_HEIGHT) : undefined,
      marginRight: containerStyle.marginRight ? getResponsiveDimension(containerStyle.marginRight, SCREEN_WIDTH) : undefined,
    };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.scrollContainer}>
        ...
        >
          ...
          <View style={{ width: getResponsiveDimension(20, SCREEN_WIDTH) }} />
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    ...
    left: 0,
    right: 0,
    height: getResponsiveDimension(44, SCREEN_HEIGHT),
  },
  scrollView: {
    flex: 1,
  },
  scrollContentContainer: {
    paddingHorizontal: getResponsiveDimension(5, SCREEN_WIDTH),
    paddingVertical: getResponsiveDimension(3, SCREEN_HEIGHT),
  },
  imageWrapper: {
    position: 'relative',
  },
  ...
  profileScrollContainer: {
    position: 'absolute',
    top: getResponsiveDimension(8, SCREEN_HEIGHT),
    left: getResponsiveDimension(1, SCREEN_WIDTH),
    width: SCREEN_WIDTH,
  ...
  profileImage: {
    ...
    height: CONTAINER_HEIGHT,
    borderRadius: getResponsiveDimension(2, SCREEN_WIDTH),
  },
  ...
  errorContainer: {
    position: 'absolute',
    bottom: getResponsiveDimension(2, SCREEN_HEIGHT),
    left: getResponsiveDimension(2, SCREEN_WIDTH),
    right: getResponsiveDimension(2, SCREEN_WIDTH),
    padding: getResponsiveDimension(1, SCREEN_WIDTH),
    backgroundColor: 'rgba(255,0,0,0.8)',
    borderRadius: getResponsiveDimension(0.5, SCREEN_WIDTH),
  },
  errorText: {
    color: 'white',
    textAlign: 'center',
