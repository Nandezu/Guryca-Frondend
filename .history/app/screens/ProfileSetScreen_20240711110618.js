  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
        ...
        style={{
          position: 'absolute',
          top: SCREEN_HEIGHT * 0.20, // 10% výšky obrazovky od horního okraje
          left: SCREEN_WIDTH * 0.10, // 50% šířky obrazovky od levého okraje
          width: SCREEN_WIDTH * 0.080, // 40% šířky obrazovky
          height: SCREEN_HEIGHT * 0.040, // 20% výšky obrazovky
          resizeMode: 'contain',
        }}
      />
