...
const AllScreen = () => {
  ...
  return (
    <View style={styles.mainContainer}>
        ...
        >
          <View style={styles.scrollItem}>
            <TouchableOpacity onPress={handledresscPress} style={styles.button}>
              <Image source={require('../../assets/images/dressc.png')} style={styles.image} resizeMode="contain" />
            </TouchableOpacity>
          </View>
          <View style={styles.scrollItem}>
      ...
      <TouchableOpacity onPress={handleSubsPress} style={styles.absoluteButton}>
        <Image source={require('../../assets/images/aib.png')} style={styles.aibImage} resizeMode="contain" />
      </TouchableOpacity>
      <TouchableOpacity onPress={handleSubsPress} style={styles.absoluteButton}>
        <Image source={require('../../assets/images/newb.png')} style={styles.newbImage} resizeMode="contain" />
      </TouchableOpacity>
      <TouchableOpacity onPress={handleSubsPress} style={styles.absoluteButton}>
        <Image source={require('../../assets/images/favb.png')} style={styles.favbImage} resizeMode="contain" />
      </TouchableOpacity>
      <TouchableOpacity onPress={handleSubsPress} style={styles.absoluteButton}>
