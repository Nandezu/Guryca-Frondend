...
const AllScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.imageContainer, { position: 'absolute', top: 300, left: 150 }]}>
        <Image
      ...
      <View style={[styles.imageContainer, { position: 'absolute', top: 240, left: 150 }]}>
        <Image
      ...
      <View style={styles.scrollContainer}>
        ...
        >
          ...
          <View style={[styles.imageWrapper, { marginRight: 20 , top: -10, left: -200 }]}>
            <Image
