...
const ProfileSetScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {renderNewButton('Contact Form', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.73, backgroundColor: '#053453' }], () => Linking.openURL('https://www.nandezu.com/contact'), { color: 'white' })}
