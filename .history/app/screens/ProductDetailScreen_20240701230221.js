...
const ProductDetailScreen = () => {
  ...
  const handleLikePress = async () => {
    try {
      if (isFavorite) {
        await axios.delete(`http://192.168.0.106:8000/favorites/toggle/`, { data: { product: product.id } });
      } else {
        await axios.post('http://192.168.0.106:8000/favorites/toggle/', { product: product.id });
      }
