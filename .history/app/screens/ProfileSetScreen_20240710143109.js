...
const ProfileSetScreen = () => {
  ...
  const renderImageWithTouchable = (
    ...
    return (
      <View>
        <View style={touchableContainerStyle}>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'black' }}>
      ...
      {renderImageWithTouchable(
        ...
        { width: SCREEN_WIDTH * 0.10, height: SCREEN_HEIGHT * 0.05 },
      ...
      {renderImageWithTouchable(
        ...
        { width: SCREEN_WIDTH * 0.5, height: SCREEN_HEIGHT * 0.10 },
      ...
      {renderImageWithTouchable(
        ...
        { width: SCREEN_WIDTH * 10, height: SCREEN_HEIGHT * 0.08 },
