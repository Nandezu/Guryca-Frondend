...
const SubScreen = () => {
  ...
  console.log('SubScreen - Received userId:', userId);  // Přidáno pro debugging
  ...
  const handleNandezuPress = () => {
    console.log('SubScreen - Navigating back to UserScreen with userId:', userId);  // Přidáno pro debugging
    if (userId) {
