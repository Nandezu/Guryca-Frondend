...
const AllScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.imageContainer, { position: 'absolute', top: 190, left: 150 }]}>
        <Image
      ...
      <View style={styles.scrollContainer}>
        <ScrollView
          ...
          style={[styles.scrollView, { marginTop: 200 }]} // Posun ScrollView dolů o 200 jednotek
        >
          {/* Třetí obrázek s vlastní velikostí a dotykovou zónou */}
          <View style={[styles.imageWrapper, { position: 'absolute', marginRight: -450, top: -10, left: -200 }]}>
            <Image
          ...
          <View style={[styles.imageWrapper, { position: 'absolute', marginRight: -450, top: -10, left: +20 }]}>
            <Image
          ...
          <View style={[styles.imageWrapper, { position: 'absolute', top: 0, left: 500 }]}>
            <Image
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    width: '100%',
    height: 600, // Nastavení výšky podle nejvyššího obrázku, můžeš upravit podle potřeby
  },
  scrollView: {
    width: '100%',
    height: '100%',
