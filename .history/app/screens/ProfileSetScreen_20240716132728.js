  ...
  return (
    <View style={styles.container}>
      ...
      {renderNewButton(
        ...
        () => Linking.openURL('https://www.nandezu.com/terms-and-coniditions'),
        { color: 'white' }
      )}
      ...
      {renderNewButton(
        ...
        () => Linking.openURL('https://www.nandezu.com/contact'),
        { color: 'white' }
      )}
      ...
      {renderNewButton(
        ...
        () => Linking.openURL('https://www.nandezu.com/faq'),
        { color: 'white' }
      )}
