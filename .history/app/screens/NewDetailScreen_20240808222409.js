...
const NewDetailScreen = () => {
  ...
  const handleProductPress = () => {
    navigation.navigate('NewScreen', { userId, selectedProfileIndex });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {renderImageWithTouchableOpacity(
        ...
        { width: SCREEN_WIDTH * 0.07, height: SCREEN_HEIGHT * 0.035 },
        'loves',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.045, left: SCREEN_WIDTH * 0.88, zIndex: 2 },
      ...
      {renderImageWithTouchableOpacity(
        ...
        { width: SCREEN_WIDTH * 0.08, height: SCREEN_HEIGHT * 0.04 },
        'subs',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.02, left: SCREEN_WIDTH * 0.050, zIndex: 2 },
        'ProfileSetScreen'
      )}
