...
const UserScreen = () => {
  ...
  const renderProfileItem = ({ item, index }) => {
    // Detekce obrázků z ImageDetailScreen podle URL parametru 'from_image_detail=true'
        ...
        <View style={styles.profileItemContainer}>
          {item.imageUrl ? (
            <Image
              ...
              style={[
                styles.profileImage, 
                isFromImageDetail && styles.transformedProfileImage // Pouze pro obrázky z ImageDetailScreen
              ]}
              resizeMode="cover"
            />
          ) : (
