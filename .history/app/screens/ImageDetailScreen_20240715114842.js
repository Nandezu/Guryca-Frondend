...
const ImageDetailScreen = () => {
  ...
  const addToProfileImages = async () => {
    try {
      ...
      // Vypočítáme novou šířku pro zachování poměru stran a aplikaci zúžení
      const scaledWidth = imageInfo.width * 0.87;
      const scaledHeight = (scaledWidth / imageInfo.width) * imageInfo.height;
  
      // Aplikujeme resize s vypočítanými rozměry
      ...
      // Vytvoříme FormData a přidáme upravený obrázek
