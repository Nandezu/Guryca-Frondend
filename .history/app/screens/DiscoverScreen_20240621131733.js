...
Get access to the world's largest selection of over 30,000 clothing products and thousands of brands, from top designers to emerging talents.
...
const styles = StyleSheet.create({
  ...
  descriptionText: {
    ...
    left: '50%',
    width: '80%',
    transform: [{ translateX: -125 }], // Center horizontally
    color: '#fff',
    fontSize: 20,
    textAlign: 'left',
  },
