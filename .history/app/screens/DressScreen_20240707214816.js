...
const DressScreen = () => {
  ...
  const renderProfileItem = ({ item, index }) => {
    const isProfileImage = index === 0;
    const imageStyle = isProfileImage ? styles.profileImage : styles.tryOnImage;
...
const styles = StyleSheet.create({
  ...
  tryOnImage: {
    width: CONTAINER_WIDTH * 0.8, // Můžete upravit podle potřeby, např. na 80% šířky
    height: CONTAINER_HEIGHT,
  },
});
