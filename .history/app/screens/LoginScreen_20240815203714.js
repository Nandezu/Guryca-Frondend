...
const styles = StyleSheet.create({
  ...
  signUpContainer: {
    position: 'absolute',
    bottom: 30, // Použijeme bottom místo top pro konzistentní umístění od spodní části obrazovky
    left: 0,
    right: 0,
    alignItems: 'center',
  },
  textButton: {
    ...
    fontSize: 15,
    marginVertical: 10,
    paddingHorizontal: 20, // Přidáme padding pro větší dotykovou plochu
  },
});