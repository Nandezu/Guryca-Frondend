  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'black' }}>
      ...
      {renderImageWithTouchable(
        ...
        { width: SCREEN_WIDTH * 0.35, height: SCREEN_HEIGHT * 0.16, position: 'absolute', top: 0, left: 0 },
        { position: 'absolute', top: SCREEN_HEIGHT * -0.008, left: SCREEN_WIDTH * 0.330, zIndex: 2 },
        { width: SCREEN_WIDTH * 0.37, height: SCREEN_HEIGHT * 0.18 },
        'nandezu',
        'UserScreen'
      )}
      {renderImageWithTouchable(
        require('../../assets/images/love.png'),
        { width: SCREEN_WIDTH * 0.07, height: SCREEN_HEIGHT * 0.035, position: 'absolute', top: 0, left: 0 },
        { position: 'absolute', top: SCREEN_HEIGHT * 0.052, right: SCREEN_WIDTH * 0.05, zIndex: 2 },
        { width: SCREEN_WIDTH * 0.09, height: SCREEN_HEIGHT * 0.055 },
        'love',
        null
      )}
      {renderImageWithTouchable(
        require('../../assets/images/subs.png'),
        { width: SCREEN_WIDTH * 0.08, height: SCREEN_HEIGHT * 0.04, position: 'absolute', top: 0, left: 0 },
        { position: 'absolute', top: SCREEN_HEIGHT * 0.050, left: SCREEN_WIDTH * 0.050, zIndex: 2 },
        { width: SCREEN_WIDTH * 0.1, height: SCREEN_HEIGHT * 0.06 },
        'subs',
        null
      )}
      ...
      {renderImageWithTouchable(
        ...
        { width: SCREEN_WIDTH * 0.5, height: SCREEN_HEIGHT * 0.15, position: 'absolute', top: 10, left: 10 },
        { position: 'absolute', top: SCREEN_HEIGHT * 0.15, left: SCREEN_WIDTH * 0.23 },
        { width: SCREEN_WIDTH * 0.4, height: SCREEN_HEIGHT * 0.2 },
        'setname',
        null
      )}
      {renderImageWithTouchable(
      ...
      {renderImageWithTouchable(
        ...
        { width: SCREEN_WIDTH * 0.3, height: SCREEN_HEIGHT * 0.08, position: 'absolute', top: 5, left: 5 },
