        ...
        <View style={styles.profileItemContainer}>
          {item.imageUrl ? (
            <Image
              ...
              style={[
                styles.profileImage,
                (index > 0 || isFromImageDetail) && styles.transformedProfileImage, // Apply transformedProfileImage style to all images with index > 0 and the main profile image if from ImageDetailScreen
              ]}
              resizeMode="cover"
            />
          ) : (
