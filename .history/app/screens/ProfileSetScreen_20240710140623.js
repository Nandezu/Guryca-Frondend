...
const ProfileSetScreen = () => {
  ...
  const renderImageWithTouchableOpacity = (
    ...
    return (
      <View style={[containerStyle, { width: imageStyle.width, height: imageStyle.height }]}>
        <TouchableOpacity
          style={{
        ...
        >
          <Image source={source} style={[imageStyle, { width: '100%', height: '100%' }]} resizeMode="contain" />
        </TouchableOpacity>
      </View>
    );
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'black' }}>
      ...
      {renderImageWithTouchableOpacity(
        ...
        { width: SCREEN_WIDTH * 0.6, height: SCREEN_HEIGHT * 0.2 },
        { position: 'absolute', top: SCREEN_HEIGHT * 0.22, right: SCREEN_WIDTH * 0.17 },
        'setemail',
        null
      )}
      {renderImageWithTouchableOpacity(
