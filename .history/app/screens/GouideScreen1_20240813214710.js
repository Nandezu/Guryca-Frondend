...
const styles = StyleSheet.create({
  ...
  allp: {
    ...
    height: 300,
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.07, // Posunuto o 20% výše (původně 0.05)
    left: '50%',
    transform: [{ translateX: -120 }],
  },
  progressText: {
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.55, // Posunuto o 20% výše (původně 0.45)
    left: '50%',
  ...
  descriptionText: {
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.62, // Posunuto o 20% výše (původně 0.52)
    left: '50%',
    width: '80%',
  ...
  confirmButton: {
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.90, // Posunuto o 20% výše (původně 0.75)
    left: '50%',
    width: 180,
    height: 45,
    borderWidth: 1,
