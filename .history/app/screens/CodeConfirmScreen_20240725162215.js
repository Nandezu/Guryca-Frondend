  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        Alert.alert('Success', 'Email confirmed successfully. You are now registered and logged in.');
        // Here you should add logic to save the user's token and other details
