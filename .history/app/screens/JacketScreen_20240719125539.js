...
const JacketScreen = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      console.log("Fetching products with category: jacket");
    ...
    return (
      <View key={product.sku || `product-${index}`} style={styles.productWrapper}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('JacketDetailScreen', { product, userId })}
          delayPressIn={100}
          delayPressOut={100}
          delayLongPress={200}
        >
  ...
  onViewableItemsChanged={onViewableItemsChanged}
     ...
     />
      ...
      {renderImageWithTouchableOpacity(
        require('../../assets/images/jacketg.png'),
        styles.dressImage,
        styles.dressButton,
        'first',
