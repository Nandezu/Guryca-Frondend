...
const DressScreen = () => {
  ...
  const handleTryOn = async (product) => {
    ...
    try {
      ...
      // POZNÁMKA: Zde implementujte volání API pro použití try-onu
      ...
      if (!useFeatureResponse.data.success) {
        // POZNÁMKA: Pokud došly try-ony, zobrazit zprávu a ukončit funkci
      ...
      // POZNÁMKA: Aktualizujte zbývající počet try-onů v kontextu
