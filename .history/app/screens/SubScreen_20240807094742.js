...
const SubScreen = () => {
  ...
  const handleBuySubscription = async (planType, duration) => {
    ...
    Alert.alert('Purchase Subscription', `You selected ${planType} for ${duration}. This feature will be implemented soon.`);
    // Here you would implement the logic to purchase a subscription
  };
