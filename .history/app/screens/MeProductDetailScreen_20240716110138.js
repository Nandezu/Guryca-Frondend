...
const MeProductDetailScreen = () => {
  ...
  const handleProductPress = () => {
    navigation.navigate('FavoriteUserScreen', { userId, selectedProductId: product.id });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {renderImageWithTouchableOpacity(
        ...
        'first',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.515, left: SCREEN_WIDTH * 0.060, zIndex: 1 },
         'FavoriteUserScreen'
      )}
      {renderImageWithTouchableOpacity(
...
const styles = StyleSheet.create({
  ...
  productManufacturer: {
    ...
    fontWeight: 'bold',
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.11,  // Upravte tuto hodnotu pro požadovanou výšku
    right: SCREEN_WIDTH * 0.59,  // Upravte tuto hodnotu pro požadovanou pozici zleva
    zIndex: 2,
