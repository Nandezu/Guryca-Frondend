  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={[styles.imageContainer, { top: 20, left: 0 }]}>
          <Image
          ...
          />
          <TouchableOpacity
            style={[styles.button, { width: 100, height: 100, top: 50, left: 150, backgroundColor: 'rgba(0, 0, 255, 0.2)' }]} // Přidáno pozadí pro ladění
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <TouchableOpacity
            style={[styles.button, { width: 80, height: 40, top: 20, left: -20, backgroundColor: 'rgba(0, 0, 255, 0.2)' }]} // Přidáno pozadí pro ladění
