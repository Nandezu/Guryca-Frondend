...
const LegginsDetailScreen = () => {
  ...
  const handleProductPress = () => {
    navigation.navigate('LegginsgScreen', { userId, selectedProfileIndex });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {renderImageWithTouchableOpacity(
        require('../../assets/images/legginsg.png'),
...
export default LegginsDetailScreen;