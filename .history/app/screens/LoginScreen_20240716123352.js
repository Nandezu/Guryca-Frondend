  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Zkontrolujeme, zda je profil kompletní
        const profileResponse = await fetch(`http://192.168.0.106:8000/user/users/${data.user_id}/`, {
          headers: {
        ...
        if (!profileData.shopping_region || !profileData.gender || !profileData.profile_image) {
          // Profil není kompletní, přesměrujeme na CompleteProfile
          console.log('Profile incomplete, navigating to CompleteProfile');
          navigation.navigate('CompleteProfile', { 
            userId: data.user_id, 
            token: data.token,
            missingFields: {
              shopping_region: !profileData.shopping_region,
              gender: !profileData.gender,
              profile_image: !profileData.profile_image
            }
          });
        } else {
          // Profil je kompletní, přesměrujeme na UserScreen
          console.log('Profile complete, navigating to UserScreen');
