...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    ...
    backgroundColor: '#000', // Přidáno černé pozadí
    justifyContent: 'center', // Centrování obsahu vertikálně
    alignItems: 'center', // Centrování obsahu horizontálně
  },
  image: {
    width: SCREEN_WIDTH * 0.8, // 80% šířky obrazovky
    height: SCREEN_HEIGHT * 0.6, // 60% výšky obrazovky
    borderRadius: 20, // Zaoblené rohy
    position: 'absolute',
    top: SCREEN_HEIGHT * 0.15, // 15% od horního okraje
    alignSelf: 'center', // Centrování horizontálně
  },
  confirmButton: {
    position: 'absolute',
