...
const ProfileSetScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {renderNewButton(
        'Set Name fgfgdfgjg',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.25, left: SCREEN_WIDTH * 0.20 },
...
const styles = StyleSheet.create({
  ...
  newButton: {
    ...
    padding: 10,
    borderRadius: 20,
    transform: [{ skewX: '-20deg' }],  // Zvýšená hodnota zkosení
  },
  newButtonText: {
    color: 'white',
    fontSize: 16,
    transform: [{ skewX: '20deg' }],  // Odpovídající opačné zkosení pro text
  },
});
