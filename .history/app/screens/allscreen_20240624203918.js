  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={[styles.imageContainer, {  marginRight: -450, top: 90, left: -200 }]}>
          <Image
        ...
        <View style={[styles.imageContainer, {  marginRight: -250, top: 90, left: -200 }]}>
          <Image
        ...
        <View style={[styles.imageContainer, {  marginRight: -20, top: 25, left: 0 }]}>
          <Image
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    width: '100%', // Nebo konkrétní šířka podle potřeby
    height: 500, // Nastavení výšky podle nejvyššího obrázku
  },
