...
const AIDetailScreen = () => {
  ...
  const handleProductPress = () => {
    navigation.navigate('AIScreen', { userId, selectedProfileIndex });
  };
      ...
      >
        <View style={styles.profileItemContainer}>
          {item.imageUrl ? (
            ...
            <Image source={require('../../assets/images/backai.png')} style={styles.profileImage} />
          )}
        </View>
      </TouchableOpacity>
    );
  ...
  return (
    <ImageBackground source={require('../../assets/images/backai.png')} style={styles.backgroundImage}>
      <FlatList
        ref={flatListRef}
        data={profiles}
      ...
      {renderImageWithTouchableOpacity(
        ...
        'first',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.450, left: SCREEN_WIDTH * 0.060, zIndex: 1 },
        'AIScreen'
      )}
      {renderImageWithTouchableOpacity(
