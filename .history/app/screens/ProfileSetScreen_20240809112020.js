...
const ProfileSetScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {renderNewButton('Terms and Conditions', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.62, backgroundColor: '#053453' }], () => Linking.openURL('https://www.nandezu.com/terms-and-coniditions'), { color: 'white' })}
