...
const ProfileSetScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {renderNewButton('Change Region', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.10 }], () => handleNavigation('ChangeRegionScreen'))}
      {renderNewButton('Change Email', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.36 }], () => handleNavigation('ChangeEmailScreen'))}
      {renderNewButton('Change Password', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.40 }], () => handleNavigation('ChangePasswordScreen'))}
