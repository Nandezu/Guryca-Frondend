...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    height: 260, // Výška kontejneru ScrollView, která omezuje oblast scrollování
    marginTop: 10, // Posunout dolů, aby byla viditelná správná oblast
    top: 270,
  },
  scrollViewContainer: {
    alignItems: 'center',
  ...
  image: {
    width: 260, // Šířka obrázků ve ScrollView
    height: 260, // Výška obrázků ve ScrollView
    marginHorizontal: 1,
  },
  button: {
    alignItems: 'center',
