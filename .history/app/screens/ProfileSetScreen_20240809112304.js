...
const ProfileSetScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={require('../../assets/images/setglobe.png')} style={[styles.iconImage, { top: SCREEN_HEIGHT * 0.13 }]} />
      <Image source={require('../../assets/images/setoemail.png')} style={[styles.iconImage, { top: SCREEN_HEIGHT * 0.29 }]} />
      <Image source={require('../../assets/images/setpass.png')} style={[styles.iconImage, { top: SCREEN_HEIGHT * 0.37 }]} />
      ...
      {renderNewButton('Terms and Conditions', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.64, backgroundColor: '#053453' }], () => Linking.openURL('https://www.nandezu.com/terms-and-coniditions'), { color: 'white' })}
      {renderNewButton('Contact Form', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.72, backgroundColor: '#053453' }], () => Linking.openURL('https://www.nandezu.com/contact'), { color: 'white' })}
      {renderNewButton('FAQ', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.80, backgroundColor: '#053453' }], () => Linking.openURL('https://www.nandezu.com/faq'), { color: 'white' })}
      {renderNewButton('Logout', [styles.buttonStyle, { top: SCREEN_HEIGHT * 0.89, backgroundColor: '#CFD6DE' }], handleLogout, { color: 'black' })}
    </View>
  );
};
