...
export default function UploadPhoto() {
  ...
  const uploadPhoto = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/user/users/${userId}/upload_profile_image/`, formData, {
        headers: {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        console.log('Navigating to UploadPhoto2 with userId:', userId);
        navigation.navigate('UploadPhoto2', { userId });
      } else {
...
const styles = StyleSheet.create({
  ...
  selectButton: {
    position: 'absolute',
    bottom: SCREEN_HEIGHT * 0.10, // Posunuto nahoru o 15%
    width: 180,
    height: 45,
    borderWidth: 1,
    borderColor: '#fff',
  ...
  imageContainer: {
    ...
    marginBottom: 40,
    marginTop: -SCREEN_HEIGHT * 0.15, // Posunuto nahoru o 15%
  },
  image: {
    width: '100%',
    height: '100%',
  ...
  confirmButton: {
    ...
    width: 160,
    height: 50,
    top: SCREEN_HEIGHT * 0.8, // Posunuto nahoru o 15%
  ...
  repeatButton: {
    ...
    width: 160,
    height: 50,
    top: SCREEN_HEIGHT * 0.72, // Posunuto nahoru o 15%
    right: SCREEN_WIDTH * 0.27,
  },
  buttonImage: {
    width: '100%',
