...
const styles = StyleSheet.create({
  ...
  productManufacturer: {
    fontSize: 22,
    fontWeight: 'bold',
    top: SCREEN_HEIGHT * -0.009,  // Zachováme původní pozici
    right: SCREEN_WIDTH * 0.295,
    zIndex: 2,
    transform: [{ rotate: '90deg' }],
    textAlign: 'left',
    textAlignVertical: 'top',
    width: SCREEN_WIDTH * 0.35,  // Zachováme původní šířku
    height: SCREEN_HEIGHT * 0.2,  // Zvětšíme výšku, např. na 20% výšky obrazovky
    position: 'absolute',  // Přidáme absolutní pozicování
