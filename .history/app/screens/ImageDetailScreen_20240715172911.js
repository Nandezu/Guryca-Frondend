...
const styles = StyleSheet.create({
  ...
  addToProfileButton: {
    position: 'absolute',
    bottom: -SCREEN_HEIGHT * 0.1, // Upravte tuto hodnotu podle potřeby
    right: SCREEN_WIDTH * 0.05, // Upravte tuto hodnotu pro horizontální pozici
    width: SCREEN_WIDTH * 0.15, // Zvětšete šířku tlačítka
    height: SCREEN_WIDTH * 0.15, // Zvětšete výšku tlačítka
    justifyContent: 'center',
    alignItems: 'center',
  },
