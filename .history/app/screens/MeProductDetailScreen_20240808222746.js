...
import { View, Image, TouchableOpacity, StyleSheet, Dimensions, Text, Linking, ScrollView, FlatList, ImageBackground } from 'react-native';
...
const MeProductDetailScreen = () => {
  ...
  const handleProductPress = () => {
    navigation.navigate('FavoriteUserScreen', { userId, selectedProfileIndex });
  };
  ...
  return (
    <ImageBackground source={require('../../assets/images/backroundme.png')} style={styles.backgroundImage}>
      <FlatList
        ref={flatListRef}
        data={profiles}
      ...
      {renderImageWithTouchableOpacity(
        ...
        'first',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.46, left: SCREEN_WIDTH * 0.060, zIndex: 1 },
        'FavoriteUserScreen'
      )}
      {renderImageWithTouchableOpacity(
      ...
      {renderImageWithTouchableOpacity(
        ...
        { width: SCREEN_WIDTH * 0.08, height: SCREEN_HEIGHT * 0.04 },
        'subs',
        { position: 'absolute', top: SCREEN_HEIGHT * 0.045, left: SCREEN_WIDTH * 0.050, zIndex: 2 },
        'ProfileSetScreen'
      )}
...
export default MeProductDetailScreen;
