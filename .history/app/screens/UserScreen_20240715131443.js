...
const UserScreen = () => {
  ...
  const renderProfileItem = ({ item, index }) => {
    const isFromImageDetail = item.imageUrl.includes('profile_image_from_image_detail');
        ...
        <View style={styles.profileItemContainer}>
          {item.imageUrl ? (
            <Image
              ...
              style={[styles.profileImage, isFromImageDetail && styles.transformedProfileImage]}
              resizeMode="cover"
            />
          ) : (
