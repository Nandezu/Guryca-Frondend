...
import { View, Image, StyleSheet, Linking, StatusBar, Text } from 'react-native';
  ...
  useEffect(() => {
    ...
    const initializeIAP = async () => {
      try {
        ...
        // You can add more IAP setup here if needed
      } catch (error) {
    ...
    return () => {
      // End the connection when the component unmounts
      RNIap.endConnection();
    };
  }, [loaded]);
...
const styles = StyleSheet.create({
  splashContainer: {
    ...
    alignItems: 'center',
    backgroundColor: '#000000', // Změněno na černé pozadí pro úvodní obrazovku
  },
  splashImage: {
    width: 100,
    height: 100,
